...
class FilesSources(AbstractDataSource):
    ...
    def create_path(self):
        ...
        self.folder_path = os.path.join(current_directory, 'data', 'extension_files') # váriavel contendo o caminho da pasta que depois pega o diretório atual e concatena os diretórios data e extension_files
